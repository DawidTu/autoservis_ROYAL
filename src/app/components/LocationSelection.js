...
export default function LocationSelection() {
  const [location, setLocation] = useState('Vyber pobočku');

  return (
    <Menu as='div' className='w-full h-full flex xl:flex-col'>
          ...
          <div className="w-full h-16 xl:h-full flex justify-center xl:justify-start xl:border-r xl:border-black/10">
            <div className="flex flex-col justify-center">
              <div className="flex flex-col xl:flex-row items-center xl:gap-x-2 gap-y-2 xl:gap-y-0">
                ...
                <div className="text-[15px] uppercase font-bold">Vyberte pobočku</div>
              </div>
